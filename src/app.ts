...
noteComponent.makeComp(document.querySelector('.page')! as HTMLElement, "afterbegin" )

const videoComponent= new VideoComponent('https://www.youtube.com/watch?v=KvIfjyyl_E4', "Youtube!");
window.onload = function(){
  videoComponent.makeComp(document.querySelector('.page')! as HTMLElement, "afterbegin" )
}

const todoComponent = new TodoComponent('Todo Title!',["할1","할2","집가고싶다","TS짱짱맨"]);
  todoComponent.makeComp(document.querySelector('.page')! as HTMLElement, "afterbegin" )


const popUpComponent = new PopUpComponent("pop UP title", "popup contentsTitle");
popUpComponent.makeComp(document.querySelector('.page')! as HTMLElement, "afterbegin" )
